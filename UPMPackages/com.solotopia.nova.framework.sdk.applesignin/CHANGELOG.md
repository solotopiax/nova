...
- WebGL 下保留配置类型所在 Runtime 程序集，避免 Config 资产中的 Apple Sign-In 配置产生 Missing types 警告。

## [0.0.19] - 2026-09-04

### Changed

- AppleSigninDemo 适配 Framework `0.6.26` 的 `IUIManager.OnOpenUIViewFail` 事件；最低 Framework 依赖同步提升至 `0.6.26`。
