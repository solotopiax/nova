// modify: local fork - 通过 Nova 统一路径入口访问内置 SDK 文件。
using System;
...
namespace WeChatWASM
{
    public class WXConvertCore
    {
        ...
        public static void Init()
        {
            ...
            {
                var absolutePath = NovaWXSDKPath.GetAbsolutePath("WebGLTemplates", "WXTemplate2022TJ");
        ...
        public static string defaultImgSrc = NovaWXSDKPath.GetAssetPath("Runtime", "wechat-default", "images", "background.jpg");
        /// <summary>
        ...
        public static WXExportError DoExport(bool buildWebGL = true)
        {
            ...
            {
                RestoreNovaBrowserWebGLPluginIsolation();
            }
        }

        // modify: local fork - 微信导出可临时启用可选原生库，导出后立即恢复普通浏览器 WebGL 隔离。
        private static void RestoreNovaBrowserWebGLPluginIsolation()
        {
#if !PLATFORM_WEIXINMINIGAME && !PLATFORM_PLAYABLEADS
            string[] pluginNames =
            {
                "libemscriptenglx.a",
                "libemscriptenglx_2021.a",
                "libemscriptenglx-mt.a",
                "libemscriptenglx-mt-wasmex.a",
                "wx_perf_2021.a",
                "wx_perf_2022.a",
            ...
            {
                string assetPath = NovaWXSDKPath.GetAssetPath("Runtime", "Plugins", pluginName);
        ...
        private static void ProcessWxPerfBinaries()
        {
            ...
            if (UnityUtil.GetSDKMode() == UnityUtil.SDKMode.Package)
            {
                ...
                {
                    NovaWXSDKPath.GetAssetPath("Runtime", "Plugins", "WxPerfJsBridge.jslib"),
                    NovaWXSDKPath.GetAssetPath("Runtime", "Plugins", "wx_perf_2022.a"),
                    NovaWXSDKPath.GetAssetPath("Runtime", "Plugins", "wx_perf_2021.a"),
                };
            }
            else
            {
        ...
        private static void ProcessWxEmscriptenGLXBinaries()
        {
            ...
            if (UnityUtil.GetSDKMode() == UnityUtil.SDKMode.Package)
            {
                glLibs = new string[]
                {
                    NovaWXSDKPath.GetAssetPath("Runtime", "Plugins", "libemscriptenglx.a"),
                    NovaWXSDKPath.GetAssetPath("Runtime", "Plugins", "libemscriptenglx_2021.a"),
                    NovaWXSDKPath.GetAssetPath("Runtime", "Plugins", "libemscriptenglx-mt.a"),
                    NovaWXSDKPath.GetAssetPath("Runtime", "Plugins", "libemscriptenglx-mt-wasmex.a"),
                };
            }
            else
            {
        ...
        private static void ProcessWxiOSMetalBinaries()
        {
            ...
            if (UnityUtil.GetSDKMode() == UnityUtil.SDKMode.Package)
            {
                glLibs = new string[]
                {
                NovaWXSDKPath.GetAssetPath("Editor", "BuildProfile", "lib", "libwx-metal-cpp.bc"),
                NovaWXSDKPath.GetAssetPath("Editor", "BuildProfile", "lib", "mtl_library.jslib"),
                };
            }
            else
            {
        ...
        private static string GetLuaAdaptorPath(string filename)
        {
            ...
            if (UnityUtil.GetSDKMode() == UnityUtil.SDKMode.Package)
            {
                return NovaWXSDKPath.GetAssetPath("Runtime", "Plugins", "LuaAdaptor", filename);
            }
        ...
        private static void SettingWXTextureMinJSLib()
        {
            ...
            if (UnityUtil.GetSDKMode() == UnityUtil.SDKMode.Package)
            {
                jsLibs = new string[]
                {
                NovaWXSDKPath.GetAssetPath("Runtime", "Plugins", "SDK-WX-TextureMin-JS-WEBGL1.jslib"),
                NovaWXSDKPath.GetAssetPath("Runtime", "Plugins", "SDK-WX-TextureMin-JS-WEBGL2.jslib"),
                NovaWXSDKPath.GetAssetPath("Runtime", "Plugins", "SDK-WX-TextureMin-JS-WEBGL2-Linear.jslib"),
                };
            }
            else
            {
