...
This file only describes the licensing boundary of `com.solotopia.simplediskutils`; it does NOT
...
本文件仅用于说明 `com.solotopia.simplediskutils` 的许可边界，不将整个包重新声明为 Solotopia 的单一 MIT 授权包。
