...
namespace Sample.GetBucketStat
{
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            Console.WriteLine($"Storage: {result.BucketStat!.Storage}");
            Console.WriteLine($"ObjectCount: {result.BucketStat!.ObjectCount}");
            // See OSS.Models.BucketStat
        }
    }
}
