...
第二行（仅 m_Master != null 时，labelWidth=80f）：
  Label("平台类型：", 64f) + EnumPopup<PlatformType>(120f，窗口本地编辑坐标) + Space(24f)
