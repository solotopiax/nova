...
namespace NovaFramework.Runtime
{
    ...
    public interface ITxtHelper
    {
        ...
        /// 格式化文本（支持参数）。
        /// </summary>
        /// <param name="format">格式化字符串，必须非空。</param>
        /// <param name="args">格式化参数，可为多个对象。</param>
        ...
        /// 获取完整字符串（可含前缀）。
        /// </summary>
        /// <param name="keyWords">关键字字符串。</param>
        /// <param name="prefixes">可选前缀数组，按顺序拼接到关键字前。</param>
        /// <returns>返回拼接后的完整字符串。</returns>
