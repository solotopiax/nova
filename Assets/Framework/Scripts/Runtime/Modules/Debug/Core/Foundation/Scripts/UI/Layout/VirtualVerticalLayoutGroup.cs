 ...
 * All Rights Reserved.
 * -------------------------------------------------------------
 * filename:  VirtualVerticalLayoutGroup.cs
 * author:    yingzheng
 * created:   2026/6/12
...
namespace NovaFramework.Runtime
{
    ...
    {
        private readonly DebugList<object> _itemList = new DebugList<object>();
        private readonly DebugList<int> _visibleItemList = new DebugList<int>();

        private bool _isDirty = false;
        private DebugList<Row> _rowCache = new DebugList<Row>();
        ...
        private DebugList<Row> _visibleRows = new DebugList<Row>();
        ...
        protected void ScrollUpdate()
        {
            ...
            //Debug.Log(" ScrollUpdate {0}".Fmt(Time.frameCount));
            ...
            {
                //Debug.Log(" IsDirty {0}".Fmt(Time.frameCount));
        ...
        public override void SetLayoutVertical()
        {
            ...
            //Debug.Log(" SetLayoutVertical {0}".Fmt(Time.frameCount));
        ...
        private Row CreateRow()
        {
            ...
            var row = DebugInstantiate.Instantiate(ItemPrefab);
