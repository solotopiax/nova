...
namespace NovaFramework.Runtime
{
    ...
    /// </summary>
    [Serializable]
    public class DebugList<T> : IList<T>, ISerializationCallbackReceiver
    {
        ...
        /// </summary>
        public DebugList(IEnumerable<T> source)
        {
            AddRange(source);
        }
