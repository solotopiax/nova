...
namespace NovaFramework.Runtime
{
    ...
    public sealed class PropertyReference
    {
        ...
        public PropertyReference(object target, PropertyInfo property)
        {
            ...
            DebugAssert.AssertNotNull(property);
...
#endif
            {
                _getter = () => DebugReflection.GetPropertyValue(target, property);
            }
...
#endif
            {
                _setter = (v) => DebugReflection.SetPropertyValue(target, property, v);
            }
        } 
        ...
        {
            DebugAssert.AssertNotNull(type);
