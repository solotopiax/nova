...
#pragma warning disable 0649
    ...
    public class Settings : ScriptableObject
    {
        ...
        private void UpgradeKeyboardShortcuts()
        {
            ...
            Debug.Log("[RuntimeDebugger] Upgrading Settings format");
        ...
        {
            var instance = Resources.Load<Settings>("Debug/" + ResourcesName);
            return instance;
        }
        ...
        private static Settings GetOrCreateInstance()
        {
            ...
            if (instance == null)
            {
                Debug.Log("[RuntimeDebugger] No RuntimeDebugger settings object found - using defaults. (Open RuntimeDebugger Settings window in the Unity Editor to create settings file)");
