 ...
 * All Rights Reserved.
 * -------------------------------------------------------------
 * filename:  PinEntryServiceImpl.cs
 * author:    yingzheng
 * created:   2026/6/12
...
namespace NovaFramework.Runtime
{
    ...
    public class PinEntryServiceImpl : DebugServiceBase<IPinEntryService>, IPinEntryService
    {
        ...
        private void Load()
        {
            var prefab = Resources.Load<PinEntryControl>(RuntimeDebuggerPaths.PinEntryPrefabPath);
            ...
            _pinControl = DebugInstantiate.Instantiate(prefab);
