 ...
 * All Rights Reserved.
 * -------------------------------------------------------------
 * filename:  SystemInformationService.cs
 * author:    yingzheng
 * created:   2026/6/12
    ...
    public class StandardSystemInformationService : ISystemInformationService
    {
        ...
        private void CreateDefaultSet()
        {
            _info.Add("System", new List<InfoEntry>
            {
                ...
                InfoEntry.Create("System Memory", DebugFileUtil.GetBytesReadable(((long) UnityEngine.SystemInfo.systemMemorySize)*1024*1024))
            ...
            _info.Add("Unity", new List<InfoEntry>
            {
                ...
                InfoEntry.Create("RuntimeDebugger Version", RuntimeDebugger.Version),
            });
...
#pragma warning disable 618
            _info.Add("Graphics - Device", new List<InfoEntry>
            {
                ...
                InfoEntry.Create("Graphics Memory", DebugFileUtil.GetBytesReadable(((long) UnityEngine.SystemInfo.graphicsMemorySize)*1024*1024)),
