 ...
 * All Rights Reserved.
 * -------------------------------------------------------------
 * filename:  PinnedUIServiceImpl.cs
 * author:    yingzheng
 * created:   2026/6/12
...
namespace NovaFramework.Runtime
{
    ...
    public class PinnedUIServiceImpl : DebugServiceBase<IPinnedUIService>, IPinnedUIService
    {
        ...
        private void Load()
        {
            var prefab = Resources.Load<PinnedUIRoot>(RuntimeDebuggerPaths.PinnedUIPrefabPath);

            if (prefab == null)
            {
                Debug.LogError("[NovaFramework.Runtime.PinnedUI] Error loading ui prefab");
                return;
            }
            ...
            _uiRoot = instance;
            UpdateAnchors();
            RuntimeDebugger.Instance.PanelVisibilityChanged += OnDebugPanelVisibilityChanged;
