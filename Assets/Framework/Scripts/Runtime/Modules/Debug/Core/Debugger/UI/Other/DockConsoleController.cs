 ...
 * All Rights Reserved.
 * -------------------------------------------------------------
 * filename:  DockConsoleController.cs
 * author:    yingzheng
 * created:   2026/6/12
...
namespace NovaFramework.Runtime
{
    ...
    public class DockConsoleController : DebugMonoBehaviourEx, IPointerEnterHandler, IPointerExitHandler
    {
        ...
        private void Refresh()
        {
            ...
            TextInfo.text = RuntimeDebuggerUtil.GetNumberString(Service.Console.InfoCount, 999, "999+");
            TextWarnings.text = RuntimeDebuggerUtil.GetNumberString(Service.Console.WarningCount, 999, "999+");
            TextErrors.text = RuntimeDebuggerUtil.GetNumberString(Service.Console.ErrorCount, 999, "999+");
