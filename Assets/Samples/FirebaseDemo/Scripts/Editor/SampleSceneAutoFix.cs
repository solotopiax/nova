 ...
 * author:    taoye
 * created:   2026/5/28
 * descrip:   切换到 FirebaseDemo scene 时自动写 Globals.json + 注入 YooAsset
 ***************************************************************/
...
{
    /// <summary>
    /// FirebaseDemo sample scene 切换守护：以 Single 模式打开本 sample 主场景时，
    ...
    public static class SampleSceneAutoFix
    {
        ...
        private static void OnSceneOpened(Scene scene, OpenSceneMode mode)
        {
            ...
            if (!scene.path.EndsWith("/FirebaseDemo.unity", System.StringComparison.Ordinal)) return;

            FirebaseConfigFileGuard.CheckActiveBuildTarget();
