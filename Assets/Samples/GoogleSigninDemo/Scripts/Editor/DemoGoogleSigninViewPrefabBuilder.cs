 ...
 * All Rights Reserved.
 * -------------------------------------------------------------
 * filename:  DemoGoogleSigninViewPrefabBuilder.cs
 * author:    Codex
 * created:   2026/06/25
 * descrip:   Google 登录 Prefab 构建器
 ***************************************************************/
...
namespace NovaFramework.Sdk.Googlesignin.Samples.Editor
{
    public static class DemoGoogleSigninViewPrefabBuilder
    {
        private const string c_ViewTypeName = "NovaFramework.Sdk.Googlesignin.Samples.Runtime.DemoGoogleSigninView";
        private const string c_BaseTypeName = "NovaFramework.Sdk.Googlesignin.Samples.Runtime.BaseDemoView";
        private const string c_BasePrefabPath = "Assets/Samples/GoogleSigninDemo/Prefabs/UIs/BaseDemoView/BaseDemoView.prefab";
        private const string c_TargetPrefabPath = "Assets/Samples/GoogleSigninDemo/Prefabs/UIs/DemoGoogleSigninView/DemoGoogleSigninView.prefab";
        ...
        public static void Build()
        {
            ...
            instance.name = "DemoGoogleSigninView";
        ...
        {
            Button loginButton = CreateButton(interactionRoot, titleText, "LoginButton", "Google 登录");
            Button logoutButton = CreateButton(interactionRoot, titleText, "LogoutButton", "Google 登出");
